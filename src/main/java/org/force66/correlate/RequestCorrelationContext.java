...
{
    private static final ThreadLocal<RequestCorrelationContext> CONTEXT = new ThreadLocal<RequestCorrelationContext>();
    ...
    public static void setCurrent(final RequestCorrelationContext context)
    {
        CONTEXT.set(context);
    }
