...
public class RequestCorrelationFilterTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        filterConfig.addInitParameter(RequestCorrelationFilter.INIT_PARM_LOGGER_NDC_NAME, "requestId");
    ...
    public void testInit() throws Exception
    {
        ...
        filter.init(filterConfig);
        Assert.assertTrue("requestId".equals(filter.getCorrelationHeaderName()));
        Assert.assertTrue("requestId".equals(filter.getLoggerMdcName()));

        filterConfig.removeInitParameter(RequestCorrelationFilter.INIT_PARM_CORRELATION_ID_HEADER);
        filterConfig.removeInitParameter(RequestCorrelationFilter.INIT_PARM_LOGGER_NDC_NAME);
        filter.init(filterConfig);
        Assert.assertTrue(
            RequestCorrelationFilter.DEFAULT_CORRELATION_ID_HEADER_NAME.equals(filter.getCorrelationHeaderName()));
        Assert.assertTrue(RequestCorrelationFilter.DEFAULT_LOGGER_MDC_NAME.equals(filter.getLoggerMdcName()));
    }
    ...
    public void testDoFilter() throws Exception
    {
        ...
        Assert.assertTrue(RequestCorrelationContext.getCurrent()
            .getCorrelationId() == null);
        Assert.assertTrue(response.getResponseContent()
            .contains("Hello"));
